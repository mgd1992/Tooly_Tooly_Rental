...
hammer = Tool.new(name: "hammer", user: marco, category: construction, description: "A tool that helps things get hammered.")
...
mixer = Tool.new(name: "mixer", user: moises, category: construction, description: "That giant rotating drum is just a concrete blender on steroids, ready to whip up a tasty batch of building material!")
...
nail = Tool.new(name: "nail", user: marco, category: construction, description: "A nail is a tiny metal spike that loves to pretend it's a superhero, saving wood from splintering one hammer swing at a time.")
...
broom = Tool.new(name: "broom", user: marco, category: cleaning, description: "Cleans really good!")
...
spray = Tool.new(name: "spray", user: moises, category: cleaning, description: "This cleaning spray is so powerful, it could clean a pig in a poke!")
...
sponges = Tool.new(name: "sponges", user: marco, category: cleaning, description: "A squishy, absorbent friend who loves to soak up messes and make bath time fun.")
...
mop = Tool.new(name: "mop", user: marco, category: cleaning, description: "A floor's best friend, always there to soak up the mess and save the day.")
...
bags = Tool.new(name: "bags", user: marco, category: cleaning, description: "They're like the unsung heroes of our homes, silently containing our trash and keeping our lives from becoming one giant dumpster fire.")
...
brushes = Tool.new(name: "brushes", user: moises, category: painting, description: "A collection of colorful, bristly friends, ready to unleash your inner artist—or make a mess of your kitchen floor.")
...
gloves = Tool.new(name: "gloves", user: marco, category: plumbing, description: "These gloves aren't just for keeping your hands clean; they're also a fashion statement. Who knew plumbing could be so glamorous?")
...
plunger = Tool.new(name: "plunger", user: moises, category: plumbing, description: "The superhero of clogged drains, ready to plunge into action and save the day from a watery mess.")
...
pliers = Tool.new(name: "pliers", user: marco, category: plumbing, description: "A pliers that's seen more pipes than a plumber's apprentice. It's the grippiest tool in town, and it's not afraid to get its hands dirty.")
...
codo = Tool.new(name: "codo", user: marco, category: plumbing, description: "")
...
smoke = Tool.new(name: "smoke", user: moises, category: electricity, description: "That little white ceiling fixture that always seems to go off when you're burning toast, but is mysteriously silent during actual house fires.")
...
cables = Tool.new(name: "cables", user: marco, category: electricity, description: "The tangled, serpentine creatures that connect our devices, but somehow always seem to be one foot too short.")
...
lighting = Tool.new(name: "lighting", user: marco, category: electricity, description: "These lights aren't just bright; they're downright illuminating! They'll make your backyard feel like a scene straight out of a summer blockbuster.")
...
mower = Tool.new(name: "mower", user: marco, category: gardening, description: "The gardener's best friend, and a neighbor's worst nightmare")
...
can = Tool.new(name: "can", user: marco, category: gardening, description: "A watercan is a vessel that's always thirsty, even though it's full of water. It's the only object that can quench your thirst while being constantly parched.")
...
rake = Tool.new(name: "rake", user: moises, category: gardening, description: "The ultimate tool for turning your yard into a leaf-free zone, one satisfying scratch at a time.")
...
shovel = Tool.new(name: "shovel", user: moises, category: gardening, description: "It's like a spoon for the dirt, but without the fancy handle or the ability to taste good.")
